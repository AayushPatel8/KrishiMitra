/*
  ...
  1. New Tables
    - `farmer_products`
      ...
      - `morning_price` (numeric, price for morning)
      - `afternoon_price` (numeric, price for afternoon)
      - `evening_price` (numeric, price for evening)
...
CREATE TABLE IF NOT EXISTS farmer_products (
  ...
  morning_price numeric NOT NULL,
  afternoon_price numeric NOT NULL,
  evening_price numeric NOT NULL,
  image_url text,
